...
// Codes : http | timeout | network | schema | scope | browser | unknown_kind | unavailable
export const ERROR_KINDS = ['http', 'timeout', 'network', 'schema', 'scope', 'browser', 'unknown_kind', 'unavailable'];
